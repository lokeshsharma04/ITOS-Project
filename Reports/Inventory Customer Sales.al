report 52133 "AME Inventory - Customer Sales"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Reports/Layout/Inventory Customer Sales.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'Inventory Customer Sales with Cost';
    ...
    dataset
    {
        dataitem(ReportHeader; "Integer")
        {
            ...
            column(ChangeCaption; ChangeCaption) { }
        }
        dataitem(Item; Item)
        {
            ...
            dataitem("Item Ledger Entry"; "Item Ledger Entry")
            {
                ...
                dataitem("Integer"; "Integer")
                {
                    ...
                    column(TempValueEntryCostAmt; TempValueEntryBuf."Cost Amount (Actual)" * -1) { }
                    ...
                    begin
                        ...
                        if ShowBelowCost and (TempValueEntryBuf."Sales Amount (Expected)" > 0) then
                            CurrReport.Skip();
                    end;
    ...
    begin
        with CurrItemLedgerEntry do begin
            ...
            ValueEntryBuf2."Cost Amount (Actual)" += "Cost Amount (Actual)" + "Cost Amount (Non-Invtbl.)";
        end;
    end;
