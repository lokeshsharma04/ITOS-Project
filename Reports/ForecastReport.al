report 52104 "AME Forecast Report"
{
    ApplicationArea = All;
    Caption = 'Forecast Report';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Reports/Layout/Forecast Report.RDL';
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                column(LineAmount_Line; "Amount Including VAT")
                {
                    AutoFormatExpression = "Currency Code";
                    AutoFormatType = 1;
                }
                ...
                begin
                    ...
                    // format := '';
                    // format := Format(totalvat1, 0, '<Precision,2><sign><Integer Thousand><Decimals,3>');

                    // format1 := '';
                    // format1 := Format(TotalAmount, 0, '<Precision,2><sign><Integer Thousand><Decimals,3>');


                    // format2 := '';
                    // format2 := Format(TotalAmountIncludingvat, 0, '<Precision,2><sign><Integer Thousand><Decimals,3>');
            ...
            begin
                ...
                if Header."Document Type" = Header."Document Type"::"Blanket Order" then
                    ...
                    if Header."Document Type" = header."Document Type"::Order then
                        ReportTitle := 'Order Confirmation';
