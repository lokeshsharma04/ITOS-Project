report 52166 "AME Account Analysis Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Reports/Layout/Account Analysis Report.RDL';
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            column(SubLedgerLbl; SubLedgerLbl) { }
            ...
            dataitem(PageCounter; "Integer")
            {
                ...
                dataitem("G/L Entry"; "G/L Entry")
                {
                    ...
                    column(Category; "Journal Batch Name") { }
                    column(Transaction_No_; "Transaction No.") { }
                    column(EventClass; EventClass) { }
    ...
    begin
        InitializeRequest(false, false, false, false, false)
    end;
    ...
    var
        ...
        DetailTrialBalCaptionLbl: Label 'Account Analysis Report';
        SubLedgerLbl: Label 'Subledger Accounting';
