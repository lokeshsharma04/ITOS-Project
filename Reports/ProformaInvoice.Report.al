report 52110 "AME Proforma Invoice Report"
{
    ApplicationArea = All;
    Caption = 'Proforma Invoice';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Reports/Layout/SalesProformaInvoice.RDL';
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(DivisionName; Header.GetDivisionName()) { }
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                column(LineAmount_Line; LineAmtInclVAT)
                {
                    // AutoFormatExpression = "Currency Code";
                    // AutoFormatType = 1;
                }
                ...
                begin
                    ...
                    check.FormatNoText(DescriptionLine, TotalAmount, Line."Currency Code");
                    ...
                    if ShowOutStandingQtyLine then begin
                        LineQty := line."Outstanding Quantity";
                        CalculateValuesForQty(LineQty, Gross_Amt, Disc_Amt, PrevLineAmount, Vat_Amt, Net_Amt);
                        // TransHeaderAmount += PrevLineAmount;
                        // TotalSubTotal += PrevLineAmount;
                        // //TotalInvDiscAmount -= Disc_Amt;
                        // TotalAmount += Gross_Amt;
                        // TotalAmountVAT += Vat_Amt;
                        // TotalAmountInclVAT += Net_Amt;
                        // //TotalPaymentDiscOnVAT += -(PrevLineAmount - Disc_Amt - Net_Amt);

                        TransHeaderAmount += PrevLineAmount;
                        PrevLineAmount := Gross_Amt;
                        //TotalSubTotal += Gross_Amt;

                        //TODO: Invoice disc. amount to be adjusted.
                        ...
                        TotalAmountVAT += Vat_Amt;
                        TotalAmountInclVAT += Net_Amt;
                        LineAmtInclVAT := Net_Amt;
                        TotalSubTotal += LineAmtInclVAT;
                        //TODO: Total payment disc. to be checked
                        ...
                        LineAmtInclVAT := "Amount Including VAT";
                        TotalSubTotal += LineAmtInclVAT;
                        TotalPaymentDiscOnVAT += -("Line Amount" - "Inv. Discount Amount" - "Amount Including VAT");
                    ...
                    if Line.Type = line.Type::Item then begin
                        if ItemRec.Get(Line."No.") then begin
                            ItemCOO := ItemRec.GetCountryOfOriginName();
                ...
                begin
                    if ShowOutStandingQtyLine then
            ...
            dataitem(Totals; "Integer")
            {
                ...
                var
                    myInt: Integer;
                begin
                    Utility.FormatNoText(AmtText, TotalSubTotal, Header."Currency Code");
            ...
            begin
                ...
                // Utility.FormatNoText(AmtText, Header."Amount Including VAT", Header."Currency Code");
                ...
                ReportTitle := format(Header."Document Type");
                if Header."Document Type" = Header."Document Type"::"Blanket Order" then
                    ReportTitle := 'Original Forecast'
                else
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    field(ShowOutStandingQtyLine; ShowOutStandingQtyLine)
                    {
                        Caption = 'Show Outstanding Line';
                        ApplicationArea = All;
                    }
    ...
    var
        ...
        COOList: Text;
        ReportTitle: Text;
        ShowOutStandingQtyLine: Boolean;
        LineQty: Decimal;
