tableextension 52129 "AME Sales Cr. Memo Line" extends "Sales Cr.Memo Line"
{
    fields
    {
        ...
        field(52103; "AME Commercial Inv. No."; Code[20])
        {
            ...
            CalcFormula = lookup("Sales Cr.Memo Header"."AME Commercial Invoice No." where("No." = field("Document No.")));
        }
