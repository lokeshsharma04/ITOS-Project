tableextension 52175 "AME Return Shipment Header" extends "Return Shipment Header"
{
    fields
    {
        ...
        field(52110; "AME Documents Attached"; Integer)
        {
            ...
            CalcFormula = count("Document Attachment" where("Table ID" = const(6650), "No." = field("No.")));
        }
    }
}
