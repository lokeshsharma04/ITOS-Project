tableextension 52173 "AME Return Receipt Line" extends "Return Receipt Line"
{
    fields
    {
        ...
        field(52103; "AME Commercial Inv. No."; Code[20])
        {
            ...
            CalcFormula = lookup("Return Receipt Header"."AME Commercial Invoice No." where("No." = field("Document No.")));
        }
