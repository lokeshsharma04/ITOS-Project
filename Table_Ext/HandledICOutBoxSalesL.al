tableextension 52171 "AME Handled IC OutBox Sales L" extends "Handled IC Outbox Sales Line"
{
    fields
    {
        ...
        field(52103; "AME Commercial Inv. No."; Code[20])
        {
            ...
            CalcFormula = lookup("Handled IC Outbox Sales Header"."AME Commercial Invoice No." where("No." = field("Document No.")));
        }
