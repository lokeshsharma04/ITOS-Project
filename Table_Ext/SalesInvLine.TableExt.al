tableextension 52128 "AME Sales Inv. Line" extends "Sales Invoice Line"
{
    fields
    {
        ...
        field(52103; "AME Commercial Inv. No."; Code[20])
        {
            ...
            CalcFormula = lookup("Sales Invoice Header"."AME Commercial Invoice No." where("No." = field("Document No.")));
        }
