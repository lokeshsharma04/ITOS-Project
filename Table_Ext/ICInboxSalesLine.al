tableextension 52170 "AME IC Inbox Sales Line" extends "IC Inbox Sales Line"
{
    fields
    {
        ...
        field(52103; "AME Commercial Inv. No."; Code[20])
        {
            ...
            CalcFormula = lookup("IC Inbox Sales Header"."AME Commercial Invoice No." where("No." = field("Document No.")));
        }
