tableextension 52130 "AME Sales Shipment Line" extends "Sales Shipment Line"
{
    fields
    {
        ...
        field(52103; "AME Commercial Inv. No."; Code[20])
        {
            ...
            CalcFormula = lookup("Sales Shipment Header"."AME Commercial Invoice No." where("No." = field("Document No.")));
        }
