tableextension 52172 "AME IC OutBox Sales Line" extends "IC Outbox Sales Line"
{
    fields
    {
        ...
        field(52103; "AME Commercial Inv. No."; Code[20])
        {
            ...
            CalcFormula = lookup("IC Outbox Sales Header"."AME Commercial Invoice No." where("No." = field("Document No.")));
        }
