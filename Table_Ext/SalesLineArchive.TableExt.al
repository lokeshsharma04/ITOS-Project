tableextension 52131 "AME Sales Line Archive " extends "Sales Line Archive"
{
    fields
    {
        ...
        field(52103; "AME Commercial Inv. No."; Code[20])
        {
            ...
            CalcFormula = lookup("Sales Header Archive"."AME Commercial Invoice No." where("Document Type" = field("Document Type"), "No." = field("Document No."), "Version No." = field("Version No.")));
        }
