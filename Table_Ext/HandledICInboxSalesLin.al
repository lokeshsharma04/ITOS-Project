tableextension 52169 "AME Handled IC Inbox Sales Lin" extends "Handled IC Inbox Sales Line"
{
    fields
    {
        ...
        field(52103; "AME Commercial Inv. No."; Code[20])
        {
            ...
            CalcFormula = lookup("Handled IC Inbox Sales Header"."AME Commercial Invoice No." where("No." = field("Document No.")));
        }
